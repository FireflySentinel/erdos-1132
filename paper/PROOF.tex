...
Selected lemmas of Section~\ref{sec:counterexample} are also formalized,
including the explicit logarithmic integral bound and the cutoff estimate
on \(F\) under geometric hypotheses, and the conditional assembly step.
Their precise scope and hypotheses are documented with the source.
