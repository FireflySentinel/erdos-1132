...
collects the four statements; \path{checks/Statement.lean} and
\path{checks/Counterexample.lean} also write out the node conditions
and Lagrange products. The source and build instructions are at
