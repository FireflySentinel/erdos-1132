...
M_U(t)\le(1-\eta)M_I(t),\qquad \eta=\kappa/4=1/128
 \quad(4s\le t\le2).
\end{equation}
The choice \(\alpha<\eta\) leaves a positive fraction of the far-field
logarithmic integral: its loss factor tends to
\((1-\eta)/(1-\alpha)<1\) as \(s\to0\).
...
Finally, concavity of the power \(\alpha\), \(\log5<2\), and \(\Theta\ge16\) give
\begin{equation}\label{eq:counter-u13}
\begin{split}
 \frac{1-\eta}{1-\alpha}\frac{\Theta_0^{-\alpha}}{p(s)}
 &=\frac{254}{255}\left(\frac{\Theta}{\Theta-\log5}\right)^{1/256}\\
...
Our choice of \(\rho\) ensures \(\Theta\ge16\), and \eqref{eq:counter-u9} yields
