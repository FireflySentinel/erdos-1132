...
The proofs are formalized in Lean 4; generative AI was used
...
\(H\ge\log(1/(4s))\). This proves \eqref{eq:counter-u9}.
...
Lemma~\ref{lem:amplitude} and the phase-midpoint calculation in
\eqref{eq:counter-u28}--\eqref{eq:counter-u29} give
\[
