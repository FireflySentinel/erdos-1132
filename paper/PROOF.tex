...
The proof of part~(ii) in Sections~\ref{sec:cauchy}--\ref{sec:ae} is
self-contained: cancellation in positive Cauchy transforms and a
harmonic-measure identity rule out a common low set of positive measure.
