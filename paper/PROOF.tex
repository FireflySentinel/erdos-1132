...
These questions are recorded as Erd\H{o}s Problem~1132 \cite{Bloom}.
A stronger uniform interpretation of the additive-constant question
is false for arbitrary triangular arrays; this is treated separately
in \cite{GuNonuniform}.
...
Sections~\ref{sec:local}--\ref{sec:fixed} prove part~(i), and
Sections~\ref{sec:cauchy}--\ref{sec:ae} prove part~(ii).
